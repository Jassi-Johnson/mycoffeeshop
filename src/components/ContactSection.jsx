...
const contactChannels = [
    {
        ...
        href: "https://maps.google.com/?q=Bean+Place+Strasburg+CO"
    },
    {
        name: "Opening Hours",
        icon: (
    ...
    },
    {
        ...
        detail: "hello@thebeanplace.com\nWe respond within 24 hours",
        action: "Send Email",
        href: "mailto:hello@thebeanplace.com"
    },
    {
        name: "Call Us",
        icon: (
        ...
        return (
            <div className="contact-section-wrap">
                ...
                <div className="contact-inner">
                    {/* Header */}
                    <ScrollReveal animation="fade-up" className="contact-header">
                        <motion.div
                            ...
                            <p
                                ...
                                style={{maxWidth: "48ch", margin: "10px auto 0", fontSize: 16}}>
                                    Where you're ordering beans, planning an event, or just want to say hello - we'd love to hear from you. 
                                </p>
                    ...
                    <motion.div
                        ...
                        varients={{ visible: { transition: { staggerChildren: 0.08 } } }}
                        >
